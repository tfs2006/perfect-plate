    ...
    async function repairPlan(plan, inputs){
      try {
        ...
        const fixRes = await secureApiCall("generate-plan", {
          endpoint: "gemini-1.5-pro-001:generateContent",
          body: {
...
Use different proteins/methods than existing recipes.`;
      ...
      const resp = await secureApiCall('generate-plan', { endpoint: 'gemini-1.5-pro-001:generateContent', body });
      ...
      try {
        ...
        async function generateBatch(daysArray, maxTokens, temperature) {
          try {
            ...
            console.log(`[generateBatch] Using model: gemini-1.5-pro-001 (optimized for structured output)`);
        ...
        async function generateDay(dayName) {
          async function tryOnce(maxTokens, temperature, attempt = 1) {
            try {
              ...
              console.log(`[generateDay] Using model: gemini-1.5-pro-001 (optimized for structured output)`);
